...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const onboardingSteps = [
    ...
    "<h2 style='text-align:center;'>Challenge Cards <br><span style='font-size:0.8em; font-weight:normal;'><i>Step 3 of 5</i></span></h2><p>As you build Momentum, you’ll unlock <b>Challenge Cards</b>: real-life actions designed to grow both your in-game progress and your real-world power. Pick a challenge, complete it in real life, then spend your Momentum to claim the reward. The higher the tier of the <b>Challenge Card</b>, the bigger the challenge and bigger in-game and real life growth rewards.</p>",
