...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const onboardingSteps = [
    ...
    "<h2 style='text-align:center;'>How to Begin <br><span style='font-size:0.8em; font-weight:normal;'><i>Step 2 of 5</i></span></h2><p><b>Hold</b> (don't click) the blue button to generate <b>Momentum Points</b>. It’s simple. But so are most first steps.</p>",
    "<h2 style='text-align:center;'>Challenge Cards <br><span style='font-size:0.8em; font-weight:normal;'><i>Step 3 of 5</i></span></h2><p>As you build Momentum, you’ll unlock <b>Challenge Cards</b>: real-life actions designed to grow both your in-game progress and your real-world power.<br>Pick a challenge, complete it in real life, then spend your Momentum to claim the reward.<br>Higher tier Challenge Cards offer bigger challenges to help you grow, and give bigger in-game rewards.</p>",
    "<h2 style='text-align:center;'>Why It Matters <br><span style='font-size:0.8em; font-weight:normal;'><i>Step 4 of 5</i></span></h2><p>Each challenge is designed to stretch you, support you, or remind you who you're becoming. They are both challenges and moments of change.</p>",
    "<h2 style='text-align:center;'>You're Ready <br><span style='font-size:0.8em; font-weight:normal;'><i>Step 5 of 5</i></span></h2><p>There’s no right way to play. Just begin. You can come back to this anytime (points grow while you're away).<br>Here are 10 Momentum Points because you took the first step of being here.<br>You are worthy of greatness. Let’s build your momentum.</p>",
    "<h2 style='text-align:center;'>This is a Prototype <br><span style='font-size:0.8em; font-weight:normal;'><i>Step 6 of 6</i></span></h2><p>This early version includes just 5 tiers and a small set of features. Expect progress loss and bugs. In the full version, you’ll find upgrades, advanced tiers, and new systems for transformation. You’re helping shape the future just by testing — thank you! I love this community!</p>"
  ];
